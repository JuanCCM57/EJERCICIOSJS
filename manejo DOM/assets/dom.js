...
SELECCIONAR ELEMENTOS
 Sirve para realizar busquedas de elementos dentro del documento
 -getElementById("IDElemento"): Buscar elementos por el ID
 -getElementsByClasName("nombreClase"):Busca elementos por el nombre de la clase
 -getElementsByTagName(): Buscar un elemento por su etiqueta
 -getElementsByName(): Busca un elemento por su nombre

 MEtodos modernos

 -querySelector(): Buscar el PRIMER eleemnto que 
 coincida con el selector
 -querySelector():Buscar TODOS los elementos que
 coinciden con el selector
...
/*
CREAR ELEMENTOS
-createEleemnt(): Crea un elemento en Memoria del tipo texto
...
//Metodos para añadir , modificar y eleiminar atributos

/*
Modificar Elementos

son metodos que nos van a permitir hacer modificaciones a nuestro elementos dentro del documento HTML

-textContent: Mostrar el contenido en texto de un element
-innerHTML: Modificar el contenido en un element
-outerHTML: Mostrar el contenido con todo y etiqueta
*/

// //textContent
// encabezado.textContent;
// parrafitos.textContent;
// parrafo2.textContent;

//innerHTML
// parrafo1.innerHTML = ("lo siento, ahora yo soy el texto del parrafo1");
...
Es la forma mas sencilla, pero menos recomendable,
porque se ejecutan desde el HTML y no queremos mezclar JS con el HTML.
...
Es una forma alternativa de gestionar eventos,
 creando HTML desde la API DOM 
 (Pero es una trampa porque seguimos usando HTML para el uso del boton)

En lugar de agregar el atributo onclick al boton,
 lo localizamos mediante un querySelector.
  Luego le asignamos una funcion con el codigo deseado,
...
Permite agregar una escucha del evento indicado (primer parametro),
 y en elcaso de que ocurra, se ejecuta la funcion asociada indicada (segundo parametro)
...
button.addEventListener("click",function(){
    alert("hola,saludos con un evento Listener");
})